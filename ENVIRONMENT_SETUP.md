...
This guide will help you set up the zeroqc development environment and troubleshoot common issues.
...
- `DATABASE_URL`: PostgreSQL connection string
  ```
  DATABASE_URL=postgresql://zeroqc_user:zeroqc_password@localhost:5432/zeroqc
  ```
...
1. **Check PostgreSQL:**
   ...
   - Test connection: `psql postgresql://zeroqc_user:zeroqc_password@localhost:5432/zeroqc`
