...
const WorkspaceInvitationEmail = ({
  ...
  <Html>
    <Head />
    <Body style={main}>
      <Preview>You've been invited to join {workspaceName} on zeroqc.</Preview>
      <Container style={container}>
        ...
        <Section style={body}>
          <Text style={paragraph}>
            ...
            join the <strong>{workspaceName}</strong> workspace on zeroqc.
          </Text>
          <Text style={paragraph}>
          ...
          <Hr />
          <Text style={footerParagraph}>zeroqc</Text>
        </Section>
      </Container>
    </Body>
  </Html>
...
WorkspaceInvitationEmail.PreviewProps = {
  ...
  invitationLink: "https://zeroqc.app/invite/abc123",
