---
title: App Setup
description: Learn how to create and configure a GitHub App for zeroqc integration. Step-by-step guide to register your zeroqc instance with GitHub.
---

import { Step, Steps } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

This guide walks you through creating and configuring a GitHub App to enable the zeroqc integration. **Start here before deploying or configuring your zeroqc instance.**

## Overview

A GitHub App provides secure, granular access to your repositories and allows zeroqc to:
...
<Callout type="error">
**Important**: Complete this GitHub App setup **before** deploying zeroqc. You'll need the app credentials during deployment configuration.
</Callout>
...
- **GitHub App name**: `zeroqc-[your-instance-name]` (must be unique across GitHub)
- **Description**: `zeroqc project management integration`
- **Homepage URL**: Your planned zeroqc instance URL (e.g., `https://zeroqc.yourdomain.com`)
- **Webhook URL**: `https://your-zeroqc-instance.com/github-integration/webhook`
- **Webhook secret**: Generate a secure random string (save this for later)

<Callout type="warning">
Replace `your-zeroqc-instance.com` with your planned zeroqc domain. The webhook URL must be publicly accessible once deployed.
</Callout>
</Step>
...
<Callout type="error">
**Required**: You must subscribe to **Issues** events for the integration to work properly. This enables bidirectional synchronization between zeroqc tasks and GitHub issues.
</Callout>

<Callout type="info">
These webhook events enable real-time synchronization between your zeroqc tasks and GitHub issues.
</Callout>
</Step>
...
<Callout type="warn">
Keep this private key secure! It's used to authenticate your zeroqc instance with GitHub.
</Callout>
</Step>
...
### App Configuration
- **Use descriptive names**: Make it clear the app is for zeroqc integration
...
- Adding your organization name: `zeroqc-mycompany`
- Adding a timestamp: `zeroqc-mycompany-2024`
- Using a different naming convention: `mycompany-zeroqc`

### Webhook URL Not Accessible
Ensure your zeroqc instance is:
...
1. **[Deploy zeroqc](/docs/getting-started/deployment)** - Deploy your zeroqc instance with the GitHub App credentials
2. **[Configure GitHub Integration](/docs/integrations/github/configuration)** - Complete the integration setup in your deployed zeroqc instance
