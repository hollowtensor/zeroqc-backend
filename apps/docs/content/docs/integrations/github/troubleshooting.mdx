...
**Symptoms**:
- Red error message in zeroqc UI
...
<Callout type="tip">
Use the "Browse Repositories" feature in zeroqc to see which repositories your app can access.
</Callout>
...
3. **Restart Backend Service**
   ...
   - For Kubernetes: `kubectl rollout restart deployment/zeroqc-backend`
...
**Problem**: GitHub events aren't reaching zeroqc.

**Symptoms**:
- Webhook events listed in GitHub but no logs in zeroqc
...
**Problem**: Webhooks reach zeroqc but signature verification fails.
...
2. **Test Repository Access**
   - Use the "Browse Repositories" feature in zeroqc
...
2. **Gather Information**
   ...
   - Check both zeroqc logs and GitHub webhook delivery logs
   - Document your environment (Docker, Kubernetes, etc.)

3. **Test Basic Functionality**
   - Try creating a task without GitHub integration
   - Verify your zeroqc instance is working normally
...
- **[GitHub Issues](https://github.com/usezeroqc/zeroqc/issues)** - Report bugs or request features
...
**Still stuck?** The zeroqc community is here to help! Join our [Discord](https://discord.gg/rU4tSyhXXU) for real-time support.