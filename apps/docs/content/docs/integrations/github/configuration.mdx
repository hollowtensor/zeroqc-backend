...
description: Configure zeroqc with your GitHub App credentials and connect projects to repositories. Includes Docker Compose and Kubernetes examples.
---

import { Step, Steps } from 'fumadocs-ui/components/steps';
import { Callout } from 'fumadocs-ui/components/callout';

This guide covers configuring zeroqc with your GitHub App credentials and connecting projects to repositories.
...
Add the following environment variables to your zeroqc deployment:
...
GITHUB_APP_NAME=zeroqc-your-instance-name
```
...
| `GITHUB_APP_NAME` | App name for installation URLs | ⚠️ | `zeroqc-mycompany` |
  ...
  backend:
    ...
    environment:
      ...
      GITHUB_PRIVATE_KEY: |
        ...
        -----END RSA PRIVATE KEY-----
      GITHUB_WEBHOOK_SECRET: "your-webhook-secret-here"
      GITHUB_APP_NAME: "zeroqc-mycompany"
...
1. zeroqc will verify that your GitHub App has access
...
Create a new task in your connected zeroqc project with:
- A clear title
- A description
...
- The issue title starts with `[zeroqc]`
- The issue has appropriate labels (`zeroqc`, `priority:*`, `status:*`)
...
3. Each zeroqc project can connect to any repository where your app is installed

### Custom Labels
Currently, zeroqc uses these default labels:
- `zeroqc` - All issues created by zeroqc
